  ...
  static getMenuOptions(BuildContext context, double width, double height,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
            //PLAY
            SingleMenuOption_GUI.getMenuOption(context, boxWidth, boxHeight, 'Card_Play', anims[0],
                function: () => AppNavigator.navigateToScreen(context, LevelPicker()),
            ),
            Padding(padding: EdgeInsets.only(left: padding)),
            // GHOSTS
            SingleMenuOption_GUI.getMenuOption(context, boxWidth, boxHeight, 'Card_Ghosts', anims[1], 
                function: () => AppNavigator.navigateToScreen(context, GhostsScreen()),
            ),
            Padding(padding: EdgeInsets.only(left: padding)),
            //STORE
